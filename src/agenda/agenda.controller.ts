...
export class AgendaController {
  ...
  listar(
    ...
    return this.agendaService.listar({ expedienteId, responsableId, desde, hasta, estado });
  }

  @Get(':id')
  obtener(@Param('id') id: string) {
    return this.agendaService.obtenerPorId(id);
  }
  ...
  @Patch(':id')
  actualizar(@Param('id') id: string, @Body() dto: ActualizarEventoAgendaDto) {
    return this.agendaService.actualizar(id, dto);
  }
}
