...
import { AnalisisJuridicoController, AnalisisJuridicoGlobalController } from './analisis-juridico.controller.js';

@Module({
  imports: [TypeOrmModule.forFeature([Expediente])],
  controllers: [AnalisisJuridicoController, AnalisisJuridicoGlobalController],
